...
WebUI.waitForElementVisible(findTestObject('GoPro UI/Programming/link_Programming'), 20)

WebUI.click(findTestObject('GoPro UI/Programming/link_Programming'))

WebUI.waitForElementVisible(findTestObject('GoPro UI/Programming/field_Inspector'), 20)

WebUI.setText(findTestObject('GoPro UI/Programming/field_Inspector'), 'Autotest_1')

WebUI.waitForElementVisible(findTestObject('GoPro UI/Programming/dropdown_Inspector'), 20)

WebUI.click(findTestObject('GoPro UI/Programming/dropdown_Inspector'))
...
WebUI.waitForElementVisible(findTestObject('GoPro UI/Navigation/link_My_Cases_Inspector'), 20)

WebUI.click(findTestObject('GoPro UI/Navigation/link_My_Cases_Inspector'))
...
WebUI.verifyElementVisible(findTestObject('GoPro UI/Actions Menu/input_Event_Date'))
