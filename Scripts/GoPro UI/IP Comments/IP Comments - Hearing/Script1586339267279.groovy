...
WebUI.waitForElementPresent(findTestObject('GoPro UI/Case Summary/input_Search'), 10)
...
if (WebUI.waitForElementVisible(findTestObject('GoPro UI/Case Documents/link_LPA_Statement'), 20) == false) {
