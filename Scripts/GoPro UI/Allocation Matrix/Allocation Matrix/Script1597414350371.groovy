...
for (int iRow = 1; iRow <= GlobalVariable.driverCount; iRow++)
{
	...
	WebUI.verifyElementAttributeValue(findTestObject('Object Repository/GoPro UI/Case Summary/field_Grade'), 'defaultSelected', 'true', 5)
	
	WebUI.verifyElementText(findTestObject('Object Repository/GoPro UI/Case Summary/field_Score'), verData.getValue(1, 1))
