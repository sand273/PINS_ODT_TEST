...
for (int iRow = 1; iRow <= GlobalVariable.driverCount; iRow++) 
{
    ...
    WebUI.callTestCase(findTestCase('GoPro UI/Appeal Process/Case Start - Auto-Validate'), [:], FailureHandling.STOP_ON_FAILURE)
    ...
    WebUI.callTestCase(findTestCase('GoPro UI/LPA Statement/LPA Statement - Auto-Validate'), [:], FailureHandling.STOP_ON_FAILURE)
