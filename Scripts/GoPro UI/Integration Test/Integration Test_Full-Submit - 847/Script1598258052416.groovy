...
for (int iRow = 1; iRow <= GlobalVariable.driverCount; iRow++) 
{
    ...
    WebUI.callTestCase(findTestCase('GoPro UI/Appeal Process/Verify Timeline - 847'), [:], FailureHandling.STOP_ON_FAILURE)

    WebUI.callTestCase(findTestCase('Self Service Portal/Appeal Started/Verify Appeal Started'), [:], FailureHandling.STOP_ON_FAILURE)

	WebUI.callTestCase(findTestCase('Self Service Portal/Appellant Statement/Submit Statement'), [:], FailureHandling.STOP_ON_FAILURE)
	...
	WebUI.callTestCase(findTestCase('Self Service Portal/Cost Application/Cost Application'), [:], FailureHandling.STOP_ON_FAILURE)
	...
	WebUI.callTestCase(findTestCase('GoPro UI/Event Date/Assign Date - Publish - 847'), [:], FailureHandling.STOP_ON_FAILURE)
