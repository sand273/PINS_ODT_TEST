...
WebUI.verifyElementText(findTestObject('Plans/message_Plan document'), verData.getValue(1, 35))

not_run: WebUI.callTestCase(findTestCase('Generic/Help_File_Formats'), [('linkHelpFormat') : 'Object Repository/Plans/summary_Help with file formats'
        , ('listHelpFormat') : 'Object Repository/Plans/list_Help_File_Formats', ('listHelpFormat') : 'Object Repository/Plans/list_Help_File_Formats'], 
