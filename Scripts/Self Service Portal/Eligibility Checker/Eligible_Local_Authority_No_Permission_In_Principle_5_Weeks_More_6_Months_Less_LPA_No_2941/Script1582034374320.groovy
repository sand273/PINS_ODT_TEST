...
WebUI.click(findTestObject('Appeal planning decision/option_Permission_In_Principle'))
...
WebUI.verifyElementText(findTestObject('Appeal planning decision/text_Appeal_Form_Name'), verData.getValue(1, 141))
