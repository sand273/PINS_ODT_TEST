...
WebUI.click(findTestObject('Appeal planning decision/input_Option_Display_Advert'))
...
WebUI.click(findTestObject('Appeal planning decision/option_Condition_Attached_Disagree_With'))
...
WebUI.verifyElementText(findTestObject('Appeal planning decision/text_Appeal_Form_Name'), verData.getValue(1, 126))
