...
WebUI.click(findTestObject('Appeal planning decision/option_Technical_Design_Consent'))
...
WebUI.verifyElementText(findTestObject('Appeal planning decision/end_User_Question'), verData.getValue(1, 112))
...
WebUI.verifyElementText(findTestObject('Appeal planning decision/text_Appeal_Form_Name'), verData.getValue(1, 142))

WebUI.verifyMatch(WebUI.getText(findTestObject('Appeal planning decision/text_Appeal_Form_Days')), ('.*You have ' + testData.getValue(
        '6 Months Plus 5 Weeks', 1)) + ' days left to submit your appeal.*', true, FailureHandling.STOP_ON_FAILURE)
