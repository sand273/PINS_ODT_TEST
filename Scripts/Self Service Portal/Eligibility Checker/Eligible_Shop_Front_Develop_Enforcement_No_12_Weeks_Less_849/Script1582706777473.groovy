...
WebUI.click(findTestObject('Appeal planning decision/input_Option_Shop_Front'))
...
WebUI.verifyElementText(findTestObject('Appeal planning decision/text_Appeal_Form_Name'), verData.getValue(1, 133), FailureHandling.CONTINUE_ON_FAILURE)
