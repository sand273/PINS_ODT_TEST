...
WebUI.verifyElementText(findTestObject('Appeal planning decision/text_Appeal_Form_Name'), verData.getValue(1, 125))

WebUI.verifyMatch(WebUI.getText(findTestObject('Appeal planning decision/text_Appeal_Form_Days')), ('.*You have ' + testData.getValue(
        '6 Months', 1)) + ' days left to submit your appeal.*', true, FailureHandling.STOP_ON_FAILURE)
