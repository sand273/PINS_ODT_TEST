...
WebUI.setText(findTestObject('Object Repository/Appeal a planning decision/input_Day'), testData.getValue(2, 2))

WebUI.setText(findTestObject('Object Repository/Appeal a planning decision/input_Month'), testData.getValue(3, 2))

WebUI.setText(findTestObject('Object Repository/Appeal a planning decision/input_Year'), testData.getValue(4, 2))
