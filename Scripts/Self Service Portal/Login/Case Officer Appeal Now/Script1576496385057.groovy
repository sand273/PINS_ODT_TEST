...
WebUI.waitForElementVisible(findTestObject('Appeal planning decision/message_Appeal_Planning_Decision'), 2)

WebUI.verifyElementText(findTestObject('Appeal planning decision/message_Appeal_Planning_Decision'), verData.getValue(1, 21))
