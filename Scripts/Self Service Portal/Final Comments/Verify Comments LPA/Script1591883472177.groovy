...
{
	expTableLPA = ((((((((((((((((todaysDate + ',LPA Statement,') + todaysDate) + ',Sandeep Ramchandani Interested Party Correspondence,') + 
...
WebUI.waitForElementVisible(findTestObject('Final Comments/status_Open'), 5)
...
if (GlobalVariable.callTest == 'Auto-Validate')
{
	CustomKeywords.'custom.VerifyTable.verifyTableCount'('Complete Questionaire/table_Documents', '9')
}
