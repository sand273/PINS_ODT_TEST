...
WebUI.click(findTestObject('Preferred procedure/option_Inquiry'))
...
WebUI.waitForElementVisible(findTestObject('Preferred procedure/question_Brief_Summary_Inquiry'), 5)

WebUI.verifyElementText(findTestObject('Preferred procedure/question_Brief_Summary_Inquiry'), verData.getValue(1, 106))

WebUI.setText(findTestObject('Preferred procedure/textarea_Brief_Summary_Inquiry'), testData.getValue(2, 1))

WebUI.waitForElementVisible(findTestObject('Preferred procedure/question_Inquiry_Common_Ground'), 5)

WebUI.verifyElementText(findTestObject('Preferred procedure/question_Inquiry_Common_Ground'), verData.getValue(1, 107))

WebUI.click(findTestObject('Preferred procedure/button_Inquiry_Common_Ground_Upload'))

WebUI.callTestCase(findTestCase('Self Service Portal/Generic/Upload File'), [('exeFileName') : 'Doc_Upload.exe'], FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('Preferred procedure/button_Remove_Inquiry'), 5)
