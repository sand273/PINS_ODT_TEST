...
WebUI.waitForElementVisible(findTestObject('Ownership/message_Site_Owners'), 5)

WebUI.click(findTestObject('Ownership/option_Notified_Owners_No'))

WebUI.waitForElementVisible(findTestObject('Ownership/message_Any_Site_Owners'), 5)
...
WebUI.verifyElementPresent(findTestObject('Ownership/button_Remove_Site_Owner'), 2)

WebUI.waitForElementClickable(findTestObject('Ownership/link_Upload_Notice_File'), 5)

WebUI.click(findTestObject('Ownership/link_Upload_Notice_File'))
