...
WebUI.click(findTestObject('Other Appeals/Another_Appeal_Yes_Option'))

WebUI.setText(findTestObject('Other Appeals/Appeal_Reference_Field'), testData.getValue(1, 1))
