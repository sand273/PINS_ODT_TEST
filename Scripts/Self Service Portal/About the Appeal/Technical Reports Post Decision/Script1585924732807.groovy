...
WebUI.verifyElementText(findTestObject('Application Technical Reports/message_Technical_Reports', [('index') : 1]), verData.getValue(
        1, 62))
...
WebUI.waitForElementClickable(findTestObject('Application Technical Reports/message_Technical_Reports', [('index') : 2]), 
    5)

WebUI.click(findTestObject('Application Technical Reports/message_Technical_Reports', [('index') : 2]))
...
WebUI.waitForElementClickable(findTestObject('Application Technical Reports/message_Technical_Reports', [('index') : 3]), 
    5)

WebUI.click(findTestObject('Application Technical Reports/message_Technical_Reports', [('index') : 3]))
...
WebUI.waitForElementClickable(findTestObject('Application Technical Reports/message_Technical_Reports', [('index') : 4]), 
    5)

WebUI.click(findTestObject('Application Technical Reports/message_Technical_Reports', [('index') : 4]))
...
WebUI.waitForElementClickable(findTestObject('Application Technical Reports/message_Technical_Reports', [('index') : 5]), 
    5)

WebUI.click(findTestObject('Application Technical Reports/message_Technical_Reports', [('index') : 5]))
