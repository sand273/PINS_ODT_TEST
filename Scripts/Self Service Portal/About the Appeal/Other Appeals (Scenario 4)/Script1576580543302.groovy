...
WebUI.click(findTestObject('Other Appeals/option_Yes_Another_Appeal'))

WebUI.setText(findTestObject('Other Appeals/input_Appeal_Reference'), testData.getValue(1, 1))
