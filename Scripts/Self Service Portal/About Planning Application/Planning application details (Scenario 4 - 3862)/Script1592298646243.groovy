...
WebUI.waitForElementVisible(findTestObject('Planning Application details/question_Number_of_Dwellings'), 2)

WebUI.verifyElementText(findTestObject('Planning Application details/question_Number_of_Dwellings'), verData.getValue(1, 
        114))
