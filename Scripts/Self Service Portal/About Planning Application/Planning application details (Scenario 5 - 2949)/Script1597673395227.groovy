...
WebUI.waitForElementVisible(findTestObject('Planning Application details/question_Traveller_Pitches'), 2)

WebUI.click(findTestObject('Planning Application details/option_Travellers_11_To_15'))
...
WebUI.verifyElementVisible(findTestObject('Planning Application details/button_Remove_LPA_Original_Planning_Decision'), 
