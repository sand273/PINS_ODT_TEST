...
WebUI.verifyElementText(findTestObject('Technical Reports post decision/message_Technical_Reports'), verData.getValue(1, 62))

def data = WebUI.getText(findTestObject('Technical Reports post decision/message_Provide_Docs')).replaceAll('\\s+', '').trim()
