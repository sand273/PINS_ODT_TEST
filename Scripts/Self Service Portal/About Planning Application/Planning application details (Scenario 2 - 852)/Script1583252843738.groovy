...
WebUI.waitForElementVisible(findTestObject('Planning Application details/question_Name_Original_Application'), 10)
...
WebUI.waitForElementVisible(findTestObject('Planning Application details/question_LPA_Submit'), 10)
...
WebUI.waitForElementVisible(findTestObject('Planning Application details/question_Application_Ref'), 10)
...
WebUI.waitForElementVisible(findTestObject('Planning Application details/question_Application_Type'), 10)
...
WebUI.waitForElementVisible(findTestObject('Planning Application details/message_Development_Description'), 10)
...
WebUI.waitForElementVisible(findTestObject('Planning Application details/question_Description_Change'), 10)
...
WebUI.waitForElementVisible(findTestObject('Planning Application details/message_Upload_Application_Form'), 10)
...
WebUI.waitForElementVisible(findTestObject('Planning Application details/list_Help_File_Formats'), 10)
...
WebUI.waitForElementVisible(findTestObject('Planning Application details/message_LPA_Decision_Notice'), 10)
...
WebUI.waitForElementVisible(findTestObject('Planning Application details/list_Help_Formats_LPA_Notice'), 10)
