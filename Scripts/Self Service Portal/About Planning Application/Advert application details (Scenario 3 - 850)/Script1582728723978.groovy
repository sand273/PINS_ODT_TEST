...
WebUI.waitForElementClickable(findTestObject('Advert Application Details/link_Advert_Application'), 5)

WebUI.click(findTestObject('Advert Application Details/link_Advert_Application'))

WebUI.waitForElementVisible(findTestObject('Advert Application Details/message_Advert_Application'), 5)
