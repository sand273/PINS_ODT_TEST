...
WebUI.waitForElementVisible(findTestObject('Relevant Plans/message_Relevant_Plans', [('index') : 4]), 5)

WebUI.click(findTestObject('Relevant Plans/message_Relevant_Plans', [('index') : 4]))
...
WebUI.waitForElementVisible(findTestObject('Relevant Plans/message_Relevant_Plans', [('index') : 5]), 5)

WebUI.click(findTestObject('Relevant Plans/message_Relevant_Plans', [('index') : 5]))
