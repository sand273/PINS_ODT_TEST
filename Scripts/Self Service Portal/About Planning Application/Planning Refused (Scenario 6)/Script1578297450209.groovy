...
WebUI.click(findTestObject('Planning Refused/check_Power_Generation_Energy_Saving'))

WebUI.click(findTestObject('Planning Refused/check_Retail_Vitality_and_Viability'))

WebUI.click(findTestObject('Planning Refused/check_Shadow_Flicker'))

WebUI.click(findTestObject('Planning Refused/check_Tree_Preservation_Order'))
