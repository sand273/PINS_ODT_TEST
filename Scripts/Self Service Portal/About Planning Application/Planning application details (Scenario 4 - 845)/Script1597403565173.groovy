...
WebUI.click(findTestObject('Planning Application details/option_Yes_Housing_Land_Supply'))

WebUI.click(findTestObject('Planning Application details/option_Yes_HMO'))

WebUI.click(findTestObject('Planning Application details/option_Bedrooms_4_to_15'))
