...
WebUI.callTestCase(findTestCase('Generic/Agricultural_Holding'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('Ownership/status_Complete_Ownership'), 2)
